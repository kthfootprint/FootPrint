        ...
        return (
          <div className="comparable">
            <FontAwesomeIcon icon={faCar} />
              <p className="comparableNumber">  {Math.round(this.props.comparableNumber)} g CO2</p>
            ...
            <ReactTooltip id='tooltipparuuu' place="left" type="dark" effect="solid">
              <span>This would be the emissions <br/> of driving a modern <br/> diesel/petrol/hybrid car the same <br/> distance as your route.</span>
            </ReactTooltip>
          </div>
        );
    }
